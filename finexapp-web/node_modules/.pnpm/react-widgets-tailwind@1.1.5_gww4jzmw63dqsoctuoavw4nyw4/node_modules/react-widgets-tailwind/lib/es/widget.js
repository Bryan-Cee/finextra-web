import colors from 'tailwindcss/colors'; // @ts-ignore

import { withAlphaValue } from 'tailwindcss/lib/util/withAlphaVariable'; // @ts-ignore
...
export const plugin = ({
  ...
  if (!hasAlpha(focusColor)) focusColor = withAlphaValue(focusColor, theme('ringOpacity.DEFAULT', 0.5));
